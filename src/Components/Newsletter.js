 ...
 let tl =  gsap.timeline(
  ...
  return (
    <div className='bg-black Newsletter p-12 max-w-[1700px] mx-auto rounded-xl mt-10 mb-10'>
      <section className='content text-white flex justify-between items-center'>
        <h1 className='uppercase text-[3vw] font-semibold grotesk Text'>Want to get in touch ?</h1> 
        <div className='flex gap-3 items-center p-10 input'>
