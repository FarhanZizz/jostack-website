...
const Project = () => {
 return (
  ...
  <section className='content ml-40 p-20'>
   <h1 className='text-[3vw] font-extrabold capitalize grotesk '>project we have build</h1>
   <p>Here we create some practical projects . You can also take some practical idea about our work !</p>
  </section>
  ...
  <div className='card-1 h-64  w-[1000px] flex gap-7 justify-between items-center p-5 rounded-2xl hover:bg-[#23094394] bg-primary text-[#ffffffb0]'>
   {/* img */}
   <div className='image h-56 hover:h-96 hover:w-full hover:z-10 delay-100 duration-300 bg-[#ffffffb0] w-[50%] rounded-2xl'>
  ...
  <div className='content-div space-y-4'>
   ...
   <p className='max-w-xl capitalize'>This Website present your identity | Live Updates | your introduction and more yourself</p>
